    ...
    <el-row :gutter="30">
      ...
      <re-col :value="12" :xs="24" :sm="24">
        <el-form-item label="菜单名称" prop="menuTitle">
          <el-input
            v-model="newFormInline.menuTitle"
            clearable
            placeholder="请输入菜单名称"
          />
        </el-form-item>
      ...
      <re-col v-if="newFormInline.menuType !== 3" :value="12" :xs="24" :sm="24">
        <el-form-item label="路由路径" prop="menuPath">
          <el-input
            v-model="newFormInline.menuPath"
            clearable
            placeholder="请输入路由路径"
          />
        </el-form-item>
      ...
      <re-col v-show="newFormInline.menuType < 2" :value="12" :xs="24" :sm="24">
        <el-form-item label="缓存页面">
          <Segmented
            :modelValue="newFormInline.keepAlive ? 1 : 0"
      ...
      >
        <el-form-item label="菜单">
          <Segmented
            :modelValue="newFormInline.showLink ? 1 : 0"
      ...
      >
        <el-form-item label="父级菜单">
          <Segmented
            :modelValue="newFormInline.showParent ? 1 : 0"
